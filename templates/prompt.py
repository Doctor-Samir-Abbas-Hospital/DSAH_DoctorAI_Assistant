...
the arabic translations must be justified from the right to the left please do that, provide the most accurate medical translations in Arabic based on the medical dictionaries provided in the context {context}
"""